...
public abstract class PythonNumber extends PythonObject {
    ...
    protected static void populateCommonNumberClassMethods(PythonClass pythonClass) {
        pythonClass.__setattr__("__int__", new BuiltInFunction() {
        ...
        pythonClass.__setattr__("__float__", new BuiltInFunction() {
            public PythonObject execute(ThreadContext context, List<PythonObject> args, Map<String, PythonObject> kwargs) {
                return args.get(0).__float__();
            }
        });
        pythonClass.__setattr__("__bool__", new BuiltInFunction() {
            public PythonObject execute(ThreadContext context, List<PythonObject> args, Map<String, PythonObject> kwargs) {
                return args.get(0).__bool__();
            }
        });
        pythonClass.__setattr__("__add__", new BuiltInFunction() {
            public PythonObject execute(ThreadContext context, List<PythonObject> args, Map<String, PythonObject> kwargs) {
        ...
        pythonClass.__setattr__("__sub__", new BuiltInFunction() {
            public PythonObject execute(ThreadContext context, List<PythonObject> args, Map<String, PythonObject> kwargs) {
                return args.get(0).__sub__(args.get(1));
            }
        });
        pythonClass.__setattr__("__mul__", new BuiltInFunction() {
            public PythonObject execute(ThreadContext context, List<PythonObject> args, Map<String, PythonObject> kwargs) {
                return args.get(0).__mul__(args.get(1));
            }
        });
        pythonClass.__setattr__("__div__", new BuiltInFunction() {
            public PythonObject execute(ThreadContext context, List<PythonObject> args, Map<String, PythonObject> kwargs) {
                return args.get(0).__div__(args.get(1));
            }
        });
        pythonClass.__setattr__("__floordiv__", new BuiltInFunction() {
            public PythonObject execute(ThreadContext context, List<PythonObject> args, Map<String, PythonObject> kwargs) {
                return args.get(0).__floordiv__(args.get(1));
            }
        });
        pythonClass.__setattr__("__mod__", new BuiltInFunction() {
            public PythonObject execute(ThreadContext context, List<PythonObject> args, Map<String, PythonObject> kwargs) {
                return args.get(0).__mod__(args.get(1));
            }
        });
        pythonClass.__setattr__("__divmod__", new BuiltInFunction() {
            public PythonObject execute(ThreadContext context, List<PythonObject> args, Map<String, PythonObject> kwargs) {
                return args.get(0).__divmod__(args.get(1));
            }
        });
        pythonClass.__setattr__("__pow__", new BuiltInFunction() {
            public PythonObject execute(ThreadContext context, List<PythonObject> args, Map<String, PythonObject> kwargs) {

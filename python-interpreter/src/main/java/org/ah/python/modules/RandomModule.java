...
public class RandomModule extends Proxy {
    ...
    static {
        ...
        TYPE.__setattr__("getstate", new BuiltInMethod() { @Override public PythonObject call0(ThreadContext context) {
            throw new UnsupportedOperationException("Function getstate not supported yet");
        }});
        TYPE.__setattr__("setstate", new BuiltInMethod() { @Override public PythonObject call0(ThreadContext context) {
            throw new UnsupportedOperationException("Function setstate not supported yet");
        }});
        TYPE.__setattr__("getrandbits", new BuiltInMethod() { @Override public PythonObject call0(ThreadContext context) {
            throw new UnsupportedOperationException("Function getrandbits not supported yet");
        }});
        TYPE.__setattr__("randrange", new BuiltInMethod() { @Override public PythonObject call0(ThreadContext context) {
            throw new UnsupportedOperationException("Function randrange not supported yet");
        }});
        TYPE.__setattr__("sample", new BuiltInMethod() { @Override public PythonObject call0(ThreadContext context) {
            throw new UnsupportedOperationException("Function sample not supported yet");
        }});
        TYPE.__setattr__("triangular", new BuiltInMethod() { @Override public PythonObject call0(ThreadContext context) {
            throw new UnsupportedOperationException("Function triangular not supported yet");
        }});
        TYPE.__setattr__("betavariate", new BuiltInMethod() { @Override public PythonObject call0(ThreadContext context) {
            throw new UnsupportedOperationException("Function betavariate not supported yet");
        }});
        TYPE.__setattr__("expovariate", new BuiltInMethod() { @Override public PythonObject call0(ThreadContext context) {
            throw new UnsupportedOperationException("Function expovariate not supported yet");
        }});
        TYPE.__setattr__("gammavariate", new BuiltInMethod() { @Override public PythonObject call0(ThreadContext context) {
            throw new UnsupportedOperationException("Function gammavariate not supported yet");
        }});
        TYPE.__setattr__("gauss", new BuiltInMethod() { @Override public PythonObject call0(ThreadContext context) {
            throw new UnsupportedOperationException("Function gauss not supported yet");
        }});
        TYPE.__setattr__("lognormvariate", new BuiltInMethod() { @Override public PythonObject call0(ThreadContext context) {
            throw new UnsupportedOperationException("Function lognormvariate not supported yet");
        }});
        TYPE.__setattr__("normalvariate", new BuiltInMethod() { @Override public PythonObject call0(ThreadContext context) {
            throw new UnsupportedOperationException("Function normalvariate not supported yet");
        }});
        TYPE.__setattr__("vonmisesvariate", new BuiltInMethod() { @Override public PythonObject call0(ThreadContext context) {
            throw new UnsupportedOperationException("Function vonmisesvariate not supported yet");
        }});
        TYPE.__setattr__("paretovariate", new BuiltInMethod() { @Override public PythonObject call0(ThreadContext context) {
            throw new UnsupportedOperationException("Function paretovariate not supported yet");
        }});
        TYPE.__setattr__("weibullvariate", new BuiltInMethod() { @Override public PythonObject call0(ThreadContext context) {
            throw new UnsupportedOperationException("Function weibullvariate not supported yet");
        }});
        TYPE.__setattr__("SystemRandom", new BuiltInMethod() { @Override public PythonObject call0(ThreadContext context) {
        ...
        TYPE.__setattr__("random", new BuiltInMethod() { @Override public PythonObject call0(ThreadContext context) {
